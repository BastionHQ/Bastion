<div>
    <form wire:submit.prevent="submit">
        <div class="form-group @error('last_name') errored @enderror">
            <div class="form-group-header">
                <label for="last_name">Фамилия</label>
            </div>
            <div class="form-group-body">
                <input class="form-control" id="last_name" type="text" placeholder="Иванов" wire:model="last_name"/>
            </div>
            @error('last_name')
        ...
        <div class="form-group @error('name') errored @enderror">
            ...
            <div class="form-group-body">
                <input class="form-control" id="name" type="text" placeholder="Иван" wire:model="name"/>
            </div>
            @error('name')
            <p class="note error">{{ $message }}</p>
            @enderror
        ...
        <div class="form-group @error('email') errored @enderror">
            ...
            <div class="form-group-body">
                <input class="form-control" id="email" type="email" placeholder="ivan@my.corp" wire:model="email"/>
            </div>
            @error('email')
            <p class="note error">{{ $message }}</p>
            @enderror
        ...
        @if($set_password)
            ...
            <div class="form-group @error('password_confirmation') errored @enderror">
                ...
                <div class="form-group-body">
                    <input class="form-control" id="password_confirmation" type="password" wire:model="password_confirmation"/>
                </div>
